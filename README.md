...
<img src="/Douyin-Go/images/数据库架构.png" style="zoom:30%;" />

**为了让表与表之间的联系更加直观我做了另外一个表格，同时这也是简易版抖音的业务逻辑**

<img src="Douyin-Go/images/表关系.png" style="zoom:30%;" />
...
<img src="Douyin-Go/images/查询逻辑.png" alt="查询逻辑" style="zoom: 40%;" />
...
![image-20230806222209710](Douyin-Go/images/image-20230806222209710.png)
